...
filtered_data_4_2 <- first_filter(expr_mat) %>%
  sec_filter()
write.csv(filtered_data_4_4, 
          '/projectnb/bf528/users/saxophone/data_p1/data_analysis_out/proj1_4_4.csv', 
          row.names = F)

write_csv(filtered_data_4_2, 
          '/projectnb/bf528/users/saxophone/data_p1/data_analysis_out/proj1_4_2.csv')
